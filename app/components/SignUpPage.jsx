    ...
    <View style={tw`flex-1 justify-start items-center bg-teal-500`}>
      ...
      <View style={tw`bg-white p-6 mt-1 rounded-xl shadow-md w-80`}>
        ...
        <TouchableOpacity style={tw`self-center`}>
          <Text style={tw`p-1 text-black-500 text-sm mt-0 text-center font-bold`}>
            Already have an account? <Text style={tw`text-teal-500`} onPress={() => navigation.navigate('Login')}>Login</Text>
          </Text>
        </TouchableOpacity>
      </View>
    </View>
