      ...
      <ScrollView style={tw`flex-1 p-4 mt-10`}>
        ...
        <View style={tw`flex-row justify-between mb-4`}>
          <View style={tw`flex-1 p-3 mr-2 flex-row items-center gap-3 ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white'} rounded-lg`}>
            <View style={tw`${darkMode ? 'bg-gray-700' : 'bg-teal-50'} p-2 rounded-lg`}>
          ...
          <View style={tw`flex-1 p-3 ml-2 flex-row items-center gap-3 ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white'} rounded-lg`}>
            <View style={tw`${darkMode ? 'bg-gray-700' : 'bg-emerald-50'} p-2 rounded-lg`}>
        ...
        <View style={tw`flex-row flex-wrap justify-between mt-3`}>
          {/* Homework Card */}
          <TouchableOpacity
            style={tw`w-[99%] p-4 mb-4 cursor-pointer border ${darkMode ? 'bg-gray-800 border-gray-700 hover:bg-gray-750 active:bg-gray-700' : 'bg-white hover:bg-gray-50 active:bg-gray-100 border-gray-200'} rounded-lg`}
            onPress={() => navigation.navigate('Homework')}
          >
            <View style={tw`flex-col items-center text-center`}>
              <View style={tw`${darkMode ? 'bg-gray-700' : 'bg-teal-50'} p-3 rounded-xl mb-2`}>
